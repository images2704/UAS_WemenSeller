...
public class CartActivity extends AppCompatActivity {
    ...
    id.ac.umn.wemenseller.PesananAdapter adapter;
    ...
    protected void onResumeFragments() {
        ...
        FirestoreRecyclerOptions<id.ac.umn.wemenseller.Pesanan> options = new FirestoreRecyclerOptions.Builder<id.ac.umn.wemenseller.Pesanan>()
                .setQuery(query, id.ac.umn.wemenseller.Pesanan.class).build();
        adapter = new id.ac.umn.wemenseller.PesananAdapter(options);
